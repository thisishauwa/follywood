...
with_node \
  ...
  --target "/Users/useruser/Downloads/talk-to-august (1)/ios/Pods/Target Support Files/Pods-TalktoAugust/ExpoModulesProvider.swift" \
  --entitlement "/Users/useruser/Downloads/talk-to-august (1)/ios/TalktoAugust/TalktoAugust.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-av" "expo-background-fetch" "expo-constants" "expo-eas-client" "expo-file-system" "expo-font" "expo-keep-awake" "expo-linear-gradient" "expo-updates"
