...
const HomeScreen = () => {
  ...
  const userGenres = user?.profile?.genre ? [user.profile.genre] : ["Action", "Comedy", "Thriller"];
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.balanceCard}>
          <ImageBackground
            source={{ uri: 'https://placehold.co/822x463' }}
          ...
          >
            <View style={styles.balanceContent}>
              ...
              <Text style={styles.balanceChange}>+${dailyChange.toLocaleString()}.00</Text>
            </View>
          </ImageBackground>
        </View>
      ...
      <View style={styles.bottomNav}>
        ...
        <TouchableOpacity style={styles.navItem}>
          <Chart size={24} color="#868686" />
        </TouchableOpacity>
        <TouchableOpacity style={styles.navItem}>
          <Briefcase size={24} color="#868686" />
        </TouchableOpacity>
        <TouchableOpacity style={styles.navItem}>
          <User size={24} color="#868686" />
        </TouchableOpacity>
      </View>
    </View>
  );
...
const styles = StyleSheet.create({
  ...
  balanceContent: {
    flex: 1,
    backgroundColor: 'rgba(3, 8, 112, 0.8)', // Overlay
    padding: 24,
    justifyContent: 'space-between',
  },
  balanceInfo: {
